...
insert into customer values ('cus4', '1234', '고객1', 'cus1@cus.cus', '000-0000-0000', '고객의 주소를 입력', '여성','2022-05-17',true, true, 0, 'BRONZE');
...
insert into recipe (r_writer, r_category, r_name, r_desc, r_product, r_unit, r_tip, r_img) values ('cus1','국·탕·찌개·전골','북어야채국','깔끔하고 건강한 맛','북어(100g),양파(100g),감자(100g),당근(100g)','1,1,2,1','1.물을 보글보글 끓여주세요.<br>2.야채를 넣어주세요.<br>3.완성!!!', 'bs.jpg');
insert into recipe (r_writer, r_category, r_name, r_desc, r_product, r_unit, r_tip, r_img) values ('cus1','밥·죽','카레라이스','간단하고 맛있는 한끼식사','양파(100g),감자(100g),당근(100g),카레(100g)','1,2,1,1','1.야채를 볶아주세요.<br>2.물을 넣고 카레가루를 넣어주세요.<br>3.완성!!!', 'crice.jpg');
