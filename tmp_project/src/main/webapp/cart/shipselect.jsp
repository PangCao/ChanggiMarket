...
<body>
	<section class="ship_sel">
		...
		<div class="d-flex justify-content-end"><a class="btn btn-success mb-3" onclick="panTo()" style="color:white;">배송지로 이동</a></div>
		<script type="text/javascript">
			function panTo() {
			    // 이동할 위도 경도 위치를 생성합니다 
			    var moveLatLon = new kakao.maps.LatLng(<%=customerMarker.getX()%>,<%=customerMarker.getY()%>);
			...
			<table class="table table-hover">
				...
				<tr>
					<td><%=dto.getName() %></td>
					<td><a onclick="panTo<%=i%>()"  style="color: blue; font-weight:500; cursor: pointer;"><%=dto.getAddr() %></a></td>
